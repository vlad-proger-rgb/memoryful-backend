...
from app.models._mixins import IDMixin, ActiveStatusMixin
...
class ChatModel(Base, IDMixin, ActiveStatusMixin):
    ...
    provider: Mapped[str] = mapped_column(default="other")  # app.enums.provider.Provider value; drives routing
    region: Mapped[str | None] = mapped_column(default=None)  # Vertex location override; None -> VERTEX_LOCATION

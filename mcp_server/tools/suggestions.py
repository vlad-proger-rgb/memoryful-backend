...
async def get_suggestions(
    ...
    """Get suggestions from Memoryful API with pagination, optionally filtered by day timestamp"""
    ...
    return cast(list[dict[str, object]], await client.get(f"/suggestions?{urlencode(params)}"))
